// phần Login với Register nên tách riêng ra thành 2 folder trong components
    ...
    <div className="w-screen h-screen bg-[url('/public/images/home/bg_nhanxet.jpg')] bg-cover bg-center">
      <div className="w-full h-full bg-dark">
        <div className="w-[500px] mx-auto py-20">
          ...
          <form className="">
            <input
              className="w-full border border-gray-300 px-3 py-3 mb-8"
              type="email"
              placeholder="Email"
            />
            <input
            ...
            <button className="w-full h-[50px] bg-black-1 hover:bg-black-2 text-white mt-8">
              Đăng nhập
            </button>
          </form>
